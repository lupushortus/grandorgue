...
const GOElementCreator::ButtonDefinitionEntry BUTTON_DEFS[] = {
  ...
  {GOSetter::KEY_REFRESH_FILES, ID_SETTER_REFRESH_FILES, true, true, false},
  {GOSetter::KEY_PREV_FILE, ID_SETTER_PREV_FILE, true, true, false},
  {GOSetter::KEY_NEXT_FILE, ID_SETTER_NEXT_FILE, true, true, false},
  {GOSetter::KEY_LOAD_FILE, ID_SETTER_LOAD_FILE, true, true, false},
  {GOSetter::KEY_SAVE_FILE, ID_SETTER_SAVE_FILE, true, true, false},
  ...
  {GOSetter::KEY_SAVE_SETTINGS, ID_SETTER_SAVE_SETTINGS, true, true, false},
  {GOSetter::KEY_ON_STATE, ID_SETTER_ON, false, true, false},
  ...
  {wxT("CrescendoOverride"), ID_SETTER_CRESCENDO_OVERRIDE, true, false, false},
